...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    def test_empty_line(self):
        with patch("sys.stdout", new=strIO()) as output:
...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def test_create_invalid_class(self):
        """
        Test case for creating an invalid class.
        """
    ...
    def test_show_invalid_class(self):
        """
        Test the behavior when an invalid class is provided for the 'show' command.
        """
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=strIO()) as output:
    ...
    def test_show_missing_id_space_notation(self):
        """
        Test for showing missing ID space notation for different model names.
        """
    ...
    def test_show_missing_id_dot_notation(self):
        """
        Test for showing missing id using dot notation for various classes.
        """
        correct = "** instance id missing **"
        with patch("sys.stdout", new=strIO()) as output:
