...
A documentation is not a simple word, it’s a real sentence explaining what’s the purpose of the module, cl
...
##Project Description
The goal of this project is to create a Python package that will help you manage a database of AirBnB listings.
